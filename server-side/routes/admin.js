...
const { blockAUser, unblockAUser, getAllCreatives, getAllCustomers, getAllUsers, getCreative, getCustomer, giveSuperCreativeTag, createAdminAccount, adminSignIn, } = adminController;
...
router.patch("/giveSuperCreativeTag", authorizeUser, isAdmin, giveSuperCreativeTag);
